<div class="card">
    <div class="card-header">
        <div class="row align-items-center">
            <div class="col-auto">
                <span class="avatar" style="background: url('https://api.dicebear.com/9.x/<?php e(config('PROFILE_PICTURE_STYLE')); ?>/svg?seed=<?php e(currentUser()['name']); ?>>')"></span>
            </div>
            <div class="col">
                <div class="card-title"><?php e(currentUser()['name']); ?></div>
            </div>
        </div>
